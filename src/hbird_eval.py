...
def hbird_evaluation(model, d_model, patch_size, dataset_name:str, data_dir:str, batch_size=64, input_size=224, augmentation_epoch=1, device='cpu', return_knn_details=False, num_neighbour=30, nn_params=None, ftr_extr_fn=None, memory_size=None):
    ...
    evaluator = HbirdEvaluation(feature_extractor, train_loader, num_neighbour=num_neighbour, augmentation_epoch=augmentation_epoch, num_classes=num_classes, device=device, nn_params=nn_params, memory_size=memory_size, dataset_size=dataset_size)
